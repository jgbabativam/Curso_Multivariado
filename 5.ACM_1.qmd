...
## En la práctica puede sea necesario pasar de una tabla disyuntiva completa a una tabla de códigos o viceversa {.smaller}
...
Como la tabla de Burt $B$ es una matriz por bloques, cuyos bloques están dados por los productos cruzados $Z_q'Z_{q'}$, los elementos de la matriz $S$ pueden escribirse como
...
* Por esta razón, en el análisis de correspondencias la variabilidad de los perfiles suele cuantificarse mediante medidas de inercia (véase, por ejemplo, @lebart2006statistique).
...
## Inercia de modalidades, preguntas y total {style="font-size: 60%;"}
...
## Contexto: Barómetro de las Américas {style="font-size: 50%;"}

El **Barómetro de las Américas** (LAPOP) es una encuesta científica transnacional que se realiza periódicamente (generalmente cada dos años) para medir las experiencias, actitudes, valores y percepciones ciudadanas en América Latina.

La edición Colombia 2021 tiene 2 993 encuestados. Usa un diseño de **muestra dividida**: distintos módulos de preguntas van a diferentes subconjuntos.
...
| Variable | Dimensión |
|:---------|:---------|
| `b2` | ¿Hasta qué punto tiene usted **respeto por las instituciones políticas** de [país]? | Respeto por las instituciones políticas | 
...
| `b4` | ¿Hasta qué punto se siente usted **orgulloso(a) de vivir bajo el sistema político** de [país] |
| `b6` | ¿Hasta qué punto piensa usted que se debe **apoyar al sistema político de** [país] |
| `b32` | ¿Hasta qué punto tiene usted **confianza en su alcaldía / intendencia / gobierno local**?" (Nota: El término exacto varía según el país, ej. "alcaldía" en Colombia/México o "municipalidad" en Chile) |
