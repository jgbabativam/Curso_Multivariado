...
ggplot(df, aes(rel_al_prof, analfabetismo)) +
  ...
  # Colores manuales para resaltar
  scale_color_manual(
    values = c("Otras ciudades" = "gray60", "Riohacha" = "red3")
  ) +
...
* Se utiliza la proporción de poblacion por ciudad
...
## Distancia de Mahalanobis: Análisis de Proximidad {style="font-size: 80%;"}
...
## Laboratorio (1/4) {style="font-size: 90%;"}
...
## Laboratorio (2/4) {style="font-size: 90%;"}
...
## Laboratorio (3/4) {style="font-size: 90%;"}
...
## Laboratorio (4/4) {style="font-size: 90%;"}
