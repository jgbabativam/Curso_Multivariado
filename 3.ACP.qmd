...
La **Encuesta Nacional de Calidad de Vida** es una investigación estadística periódica que:

- Recopila información sobre las **condiciones socioeconómicas y de vida** de los hogares colombianos
- Captura dimensiones como educación, salud, empleo, servicios públicos, vivienda y acceso a bienes
- Utiliza un **diseño muestral complejo** con estratificación y conglomeración
- Produce estimaciones a nivel nacional, regional y departamental

## Marco Legal

**Ley 1523 de 2012** (*Política Nacional de Gestión del Riesgo de Desastres*)

- Establece la **obligatoriedad de realizar la ENCV anualmente**
- Integrada en el Sistema Estadístico Nacional (SEN) bajo supervisión del DANE
- Reglamentada mediante resoluciones del Departamento Administrativo Nacional de Estadística

::: {.fragment}
::: {.callout-important}
El objetivo central de la ENCV es calcular el **Índice de Pobreza Multidimensional (IPM)**
:::
:::
...
url_img <- "https://raw.githubusercontent.com/jgbabativam/EDM/main/images/rushmore.jpg"
...
[Laboratorio ACP](https://github.com/jgbabativam/EDM/blob/main/Laboratorios/LabC_ACP.pdf)
...
Use el conjunto de datos a nivel de **Hogares** ubicado en la carpeta **DEPARTAMENTAL**. Cada grupo debe usar el siguiente código como referencia para generar el conjunto de datos que va a trabajar. Los códigos (script o archivo .Rmd) debe ser entregado junto con el informe y presentación que se usará en la socialización. 
...
## Laboratorio (4/5) {style="font-size: 85%;"}
...
Identifique: 
  - Los 4 departamentos con mejor calidad de vida general usando el criterio de correlación. 
  - Los 4 departamentos peor representados en el plano 1-2 usando el criterio de los cosenos cuadrados. 
  - Los 2 departamentos con los perfiles más similares (use la distancia entre variables sobre el plano). 
  - Los 2 departamentos con perfiles más opuestos (use la distancia entre variables sobre el plano).
...
8. Agregue las variables IPM y porcentaje de hogares en condición de pobreza  (sin transformar) como **variables suplementarias** e incluya a Bogotá como **objeto suplementario**. ¿Cómo se ubica en el plano de variables? ¿Qué componente captura mejor la pobreza multidimensional?, ¿Qué ocurrió con Bogotá? 
