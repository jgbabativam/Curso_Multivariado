...
pca_supl <- PCA(rank, ind.sup = c(1, 3, 10, 13), graph = FALSE)
...
fviz_pca_var(pca_ecv, col.var    = "cos2", repel = TRUE,
             gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
             title      = "Plano 1-2 — Indicadores de calidad de vida") + theme_bw()
```
...
- **Dim 2 (eje vertical):** diferencia entre departamentos con **alta conectividad** (internet, computador, gas natural — arriba) vs. **alta cobertura de servicios básicos** (acueducto, alcantarillado — abajo). 
