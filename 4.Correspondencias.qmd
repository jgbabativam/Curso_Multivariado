...
El ACS identifica asociaciones entre **dos** variables cualitativas. Cuando un instrumento tiene $Q \geq 3$ preguntas cualitativas, se generaliza al **Análisis de Correspondencias Múltiples (ACM)**.
...
## Tabla disyuntiva completa {style="font-size: 88%;"}
...
$$z_{q(ik)} = \begin{cases} 1 & \text{si el individuo } i \text{ seleccionó la modalidad } k \text{ de la pregunta } q \\ 0 & \text{si no} \end{cases}$$
...
| | |
|:--|:--|
| Suma por filas | $z_{i.} = Q$ (número de preguntas) |
| Suma por columnas | $z_{q(.j)}$ = número de individuos que contestaron la modalidad $j$ de $q$ |
:::

---

## Ejemplo: tabla disyuntiva completa y tabla en códigos {style="font-size: 85%;"}

$$\begin{array}{c|cccc|cc|ccc|r|ccc|}
\multicolumn{1}{c}{} & \multicolumn{9}{c}{\textbf{Tabla disyuntiva completa}} & \multicolumn{1}{r}{} & \multicolumn{3}{c}{\textbf{Tabla en códigos}} \\
\hline
ind & p_1\,o1 & p_1\,o2 & p_1\,o3 & p_1\,o4 & p_2\,o1 & p_2\,o2 & p_3\,o1 & p_3\,o2 & p_3\,o3 & & p_1 & p_2 & p_3 \\
\hline
1 & 1 & 0 & 0 & 0 & 1 & 0 & 1 & 0 & 0 & \rightarrow & 1 & 1 & 1 \\
2 & 0 & 1 & 0 & 0 & 0 & 1 & 0 & 0 & 1 & \rightarrow & 2 & 2 & 3 \\
3 & 0 & 0 & 1 & 0 & 0 & 1 & 0 & 1 & 0 & \rightarrow & 3 & 2 & 2 \\
4 & 0 & 0 & 0 & 1 & 1 & 0 & 0 & 1 & 0 & \rightarrow & 4 & 1 & 2 \\
5 & 0 & 0 & 1 & 0 & 1 & 0 & 1 & 0 & 0 & \rightarrow & 3 & 1 & 1 \\
\hline
\end{array}$$

::: {.fragment}
::: {.callout-note}
En R, la función `MCA()` del paquete `FactoMineR` acepta la **tabla en códigos** (formato largo) y construye internamente la tabla disyuntiva completa y la tabla de Burt.
:::
:::
...
$$D_q = Z_q^\prime Z_q = \text{diag}(z_{q(\cdot 1)},\, z_{q(\cdot 2)},\, \ldots,\, z_{q(\cdot p_q)})$$
...
donde $D = \text{diag}(D_1, D_2, \ldots, D_Q)$.
:::

# Inercia en el ACM {background-color="#0077b6"}

## Inercia de modalidades, preguntas y total {style="font-size: 90%;"}
...
$$I(q) = \sum_{j=1}^{p_q} I(j) = \frac{1}{Q}(p_q - 1)$$
